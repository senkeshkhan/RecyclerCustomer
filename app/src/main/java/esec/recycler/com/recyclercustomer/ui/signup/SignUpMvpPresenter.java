...
public interface SignUpMvpPresenter<V extends SignUpMvpView> extends MvpPresenter<V> {
    ...
    void onServerSignUpClick(String name ,String email, String mobile ,String password ,String zip,String address,String age,String gender, String customer);


    void onAlreadyAccountClick();
