...
public class CollectingCentersAdapter extends RecyclerView.Adapter<CollectingCentersAdapter.MyViewHolder> {
    ...
    public CollectingCentersAdapter(List<CollectingCentersModel> statementList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_collecting_centers, parent, false);
