...
public interface ProfileEditMvpPresenter<V extends  ProfileEditMvpView> extends MvpPresenter<V> {
    ...
    void onServerProfileUpdateClick(MultipartBody.Part fileToUpload, RequestBody name, RequestBody zip, RequestBody customer_id);

    void onServerProfileUpdateWithoutImageClick( RequestBody name, RequestBody zip, RequestBody customer_id);
